...
{
    public partial class Impression3 : Form
    {            String nom;
            String prenom;
            DateTime datedem;
            DateTime d1;
        ...
        public Impression3(String nom, String prenom, DateTime dd, DateTime d1, DateTime d2, String  st,String sexe,String hd,String hf)
        {
            InitializeComponent();
            this.nom = nom;
            this.prenom = prenom;
        ...
        {
            XtraReport3 imp = new XtraReport3();
